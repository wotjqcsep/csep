  ...
  <div class="vd-card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;flex-wrap:wrap;gap:8px">
      <div style="display:flex;gap:6px;align-items:center;font-weight:800;flex-wrap:wrap">품목
        ...
        <button class="btn btn-sm" style="background:#fff3bf;color:#e67700;margin:0;font-weight:700" onclick="estToggle('est_bookmarklet_box')">⭐ 북마클릿</button><span style="font-size:10px;color:var(--gray-400)">아싸컴·조이젠 <b style="color:#0ca678">사양포함</b></span></div>
    ...
    <div id="est_url_box" style="display:none;margin-bottom:10px">
      ...
      <div style="font-size:11px;color:#0ca678;margin-top:4px">✅ 컴퓨존 견적 URL 가져오기 (AI 미사용). <b>가져오기</b>=교체, <b>+ 추가</b>=기존 유지하고 뒤에 추가</div>
      <div style="font-size:11px;color:#e67700;margin-top:3px">💡 아싸컴·조이젠은 서버 차단으로 URL 불가 → <b>⭐ 북마클릿</b> 사용</div>
    </div>
    ...
    <div id="est_bookmarklet_box" style="display:none;margin-bottom:10px">
      <div style="background:#fffbeb;border:1px solid #fcc419;border-radius:8px;padding:10px">
        ...
        <div style="margin-top:6px;font-size:10px;color:var(--gray-400)">지원: 아싸컴 (장바구니 부품·조립PC, 단일상품, 조립PC 견적) · 조이젠 (장바구니, 단일상품, 조립PC 견적)</div>
      </div>
    </div>
    <div class="table-container"><table class="table">
