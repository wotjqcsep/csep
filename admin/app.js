  ...
  <div class="vd-card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;flex-wrap:wrap;gap:8px">
      <div style="display:flex;gap:6px;align-items:center;font-weight:800;flex-wrap:wrap">품목
        <button class="btn btn-sm" style="background:var(--badge-progress-bg);color:var(--badge-progress-c);margin:0;font-weight:700" onclick="estToggle('est_url_box')">🔗 URL 공유 <span style="font-size:10px;background:var(--success);color:#fff;border-radius:8px;padding:1px 6px;margin-left:2px">권장</span></button><span style="font-size:10px;color:var(--gray-400)">컴퓨존·다나와·아이코다·마이피씨샵</span>
        <button class="btn btn-sm" style="background:#e7f5ff;color:#1971c2;margin:0;font-weight:700" onclick="estToggle('est_paste_box')">📋 소스·텍스트</button><span style="font-size:10px;color:var(--gray-400)">컴퓨존·아싸컴·조이젠</span>
        ...
        <button class="btn btn-sm" style="background:#fff3bf;color:#e67700;margin:0;font-weight:700" onclick="estToggle('est_bookmarklet_box')">⭐ 북마클릿</button><span style="font-size:10px;color:var(--gray-400)">아싸컴·조이젠·다나와·아이코다·마이피씨샵 <b style="color:#0ca678">장바구니</b></span></div>
    ...
    <div id="est_url_box" style="display:none;margin-bottom:10px">
      ...
      <div style="font-size:11px;color:#e67700;margin-top:3px">💡 아싸컴·조이젠은 URL 차단 → <b>⭐ 북마클릿</b> 사용. 장바구니(로그인 필요)도 북마클릿으로.</div>
    </div>
    ...
    <div id="est_bookmarklet_box" style="display:none;margin-bottom:10px">
      <div style="background:#fffbeb;border:1px solid #fcc419;border-radius:8px;padding:10px">
        ...
        <div style="font-size:11px;color:#555;margin-bottom:8px">아래 스크립트를 복사 → 브라우저 즐겨찾기에 새 북마크 추가 → URL 칸에 붙여넣기.<br>아싸컴·조이젠·다나와·아이코다·마이피씨샵 장바구니·견적·단일상품 페이지에서 클릭하면 자동 전송됩니다.</div>
        ...
        <div style="margin-top:6px;font-size:10px;color:var(--gray-400)">지원: 아싸컴 (장바구니·단일상품·견적) · 조이젠 (장바구니·단일상품·견적) · 다나와 (장바구니·단일상품·조립PC) · 아이코다 (장바구니·단일상품) · 마이피씨샵 (장바구니·단일상품)</div>
      </div>
    </div>
    <div class="table-container"><table class="table">
