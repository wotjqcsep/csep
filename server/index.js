...
function biosAiPrompt(ocrText) {
  return [
    ...
    '값이 없으면 빈 문자열("") 또는 빈 배열([]). 지어내지 마세요. OCR 오탈자(예: i7을 17/l7, O를 0)는 문맥으로 보정하세요. cpu는 Intel/AMD 접두를 유지(예: Intel Core i3-6006U).',
    ...
    '저장장치(ssd/hdd)의 maker 필드에는 화면에 보이는 "전체 모델명"을 그대로 넣으세요(브랜드만 축약 금지). 예: "Samsung SSD 850 PRO", "WDC WD20EZRZ-00Z5HB", "WDC WD5000AAKX-22ER". 구분: 이름에 SSD/NVMe/M.2 있으면 ssd, WDC/Seagate/Toshiba 등 회전식 하드는 hdd. 용량은 화면에 있으면 넣고 없으면 비움. USB/이동식/카드리더는 제외. bios_version은 보드명과 분리.',
